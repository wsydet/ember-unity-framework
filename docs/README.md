...
从 [框架包说明](../Packages/com.ember/README.md) 了解安装与入口，从 [当前进度](dev/framework-progress.md) 了解已有能力和待办。当前发布版本为 **0.12.10**，UPM 管理器可展开查看各可升级版本的更新内容。远端中文日志读取与静态检查通过；Unity 编译、5 个新增 EditMode 案例及消费端交互待验证。模板保持 base 0.6.3 与 source3d-2p5d 0.3.5。
