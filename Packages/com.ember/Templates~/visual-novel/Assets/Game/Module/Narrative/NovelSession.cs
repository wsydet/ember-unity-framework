...
namespace Game.Narrative
{
    ...
    public sealed partial class NovelSession : INarrativeDiagnostics, IDisposable
    {
        ...
        private void Render()
        {
            ...
            string speaker = "";
            if (command != null && _catalog != null && _catalog.TryGetCharacter(command.CharacterId, out var row))
                speaker = NovelLocalization.SpeakerName(command.CharacterId, command.SpeakerNameKey, row.DisplayName);
