...
//            {
//                throw new ArgumentException("[Burner]: cannot set null IntPtr");
//            }
//            
//            BytesPtr = bytes;
...
//            if(Position >= Length)
//            {
//                throw new Exception($"[Burner]: position {Position} out of stream length {Length}");
//            }
//
//            if(BytesNativePtr == null)
//            {
//                throw new Exception("[Burner]: IntPtrStream BytesNativePtr == null");
//            }
//
//            try
//            {
...
//                    "[Burner]: the value of bytes array length must be greater than zero");
//            }
//
//            Bytes = bytes;
//            Length = bytes.Length;
...
//            if(value <= 0)
//            {
//                throw new ArgumentException("[Burner]: the value of setting length must be greater than zero");
//            }
//
//            if(value > int.MaxValue)
//            {
//                throw new ArgumentException($"[Burner]: the value of setting length must be less than int.MaxValue {int.MaxValue}");
//            }
//            
//            var originLength = Bytes.Length;
//            var newBytes = new byte[value];
//
//            var count = Mathf.Min((int)value, originLength);
...
//            if(val < 0)
//            {
//                throw new Exception("[Burner]: it cannot write negative value!");
//            }
//
//            if(val == 0)
//            {
...
//                    stream.Position = Mathf.Min((int)stream.Length, checked((int)offset));
//                    break;
//                case SeekOrigin.Current:
//                    stream.Position = Mathf.Min((int)stream.Length, checked((int)(stream.Position + offset)));
//                    break;
//                case SeekOrigin.End:
//                    stream.Position = Mathf.Min((int)stream.Length, checked((int)(stream.Length + offset)));
//                    break;
//                default:
