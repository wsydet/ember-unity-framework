...
Shader "UI/ShaderForMaskMergeImage_8"
{
    Properties
    {
        ...
        [NoScaleOffset] _Texture_7("Texture_7", 2D) = "black" {}
        _TextureColor_7("TextureColor_7", Color) = (1, 1, 1, 1)
        _TextureVisible_7("TextureVisible_7", Float) = 1
        _TextureGray_7("TextureGray_7", Float) = 1
		...
		CGPROGRAM
            ...
            fixed4 frag(v2f IN) : SV_TARGET
            {
...

                {
                    ...
                    #ifdef _ENABLE_MASK4
                        maskArray[4] = CalcMask(color4.a, maskArray[_TextureParentIndex_4], _InvTextureGenerateMask_4);
                        color4.a *= maskArray[4];
                    #endif
                    invAlpha *= (1 - color4.a);
...

                {
                    ...
                    #ifdef _ENABLE_MASK5
                        maskArray[5] = CalcMask(color5.a, maskArray[_TextureParentIndex_5], _InvTextureGenerateMask_5);
                        color5.a *= maskArray[5];
                    #endif
                    invAlpha *= (1 - color5.a);
...

                {
                    ...
                    #ifdef _ENABLE_MASK6
                        maskArray[6] = CalcMask(color6.a, maskArray[_TextureParentIndex_6], _InvTextureGenerateMask_6);
                        color6.a *= maskArray[6];
                    #endif
                    invAlpha *= (1 - color6.a);
                ...
                {
                    half2 uv = TransformUv(IN.rawTexcoord, _TexturePos_7);
                    half2 uvSample = TransformUv(uv, _TextureUvTransform_7);
                    half4 color7 = tex2D(_Texture_7, uvSample) * _TextureColor_7 * _TextureVisible_7;
                    #ifdef _ENABLE_GRAY7
                        half grayColor7 = dot(color7.rgb, half3(0.3, 0.59, 0.11));
                        color7.rgb = lerp(color7.rgb, half3(grayColor7, grayColor7, grayColor7), _TextureGray_7);
                    #endif
                    color7.a *= GetUvClipping(uv);
                    #ifdef _ENABLE_MASK7
                        maskArray[7] = CalcMask(color7.a, maskArray[_TextureParentIndex_7], _InvTextureGenerateMask_7);
                        color7.a *= maskArray[7];
                    #endif
                    invAlpha *= (1 - color7.a);
                    color = lerp(color, color7.rgb, color7.a);
                }
