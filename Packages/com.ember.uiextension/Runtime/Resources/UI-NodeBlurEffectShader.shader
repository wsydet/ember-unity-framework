Shader "UI/NodeBlurEffect"
{
    ...
    //【5】准备高斯模糊权重矩阵参数3x4的矩阵 ||  Gauss Weight
	static const half4 GaussWeight[3] =
	{
		half4(0.3078012,0.3078012,0.3078012,0),
		half4(0.384397,0.384397,0.384397,1),
		half4(0.3078012,0.3078012,0.3078012,0),
	};
	...
	half4 frag_Blur(VertexOutput_Blur i) : SV_Target
	{
		...
		half2 uv_withOffset = uv - OffsetWidth;
