...
////    public class ImageFontEditor : UnityEditor.Editor
////    {
////        bool showSyms = true;
////        string newName = "";
////        Sprite newSprite;
...
////                            TextureImporter oldTI = AssetImporter.GetAtPath(AssetDatabase.GetAssetPath(txt.SymbolData[0].Sprite)) as TextureImporter;
