...
//using Entry = Burner.UIExtension.PropertyReferenceDrawer.Entry;
//
...
//            {
//                UITweenerEditor.SetLabelWidth(82f);
//
...
//            if (remove)
//            {
//                UITweenerEditor.RegisterUndo("Delegate Selection", undoObject);
//                del.Clear();
...
//
//                            int selection;
//                            string[] props = GetNames(ents, PropertyReferenceDrawer.GetFuncName(param.obj, param.field), out selection);
//
//                            GUILayout.BeginHorizontal();
...
//            {
//                Entry ent = list[i];
//                string del = PropertyReferenceDrawer.GetFuncName(ent.target, ent.name);
//                names[++i] = del;
