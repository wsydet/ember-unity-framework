...
////
////// TMP Editor修改存档
////// 对应TMP文件位置为 Packages/com.unity.textmeshpro/Scripts/Editor/TMP_BaseEditorPanel.cs
////// 修改标记为UI_PREVIEW_MODIFY_BEGIN和UI_PREVIEW_MODIFY_END
////// 接入需要将if内的内容用UI_PREVIEW_MODIFY_BEGIN和UI_PREVIEW_MODIFY_END之间的内容替换
////#if false
////using UnityEngine;
////using UnityEditor;
...
////using System.Linq;
////
//////UI_PREVIEW_MODIFY_BEGIN
////using Burner.UIExtension.Previews;
//////UI_PREVIEW_MODIFY_END
////
////
...
////        static readonly GUIContent k_NonserializedFontLabel = new GUIContent("Nonserialized Font Asset", "[Burner]: Don't serialize the font below if enable it, in order to set it in runtime by Burner's multilanguage's components");
...
////
////        protected SerializedProperty m_NonserializedFontProp;
...
////            m_NonserializedFontProp = serializedObject.FindProperty("m_NonserializedFontAsset");
...
////        private static Dictionary<Material, Texture2D> m_TMPMaterialPreviewCache = new Dictionary<Material, Texture2D>();
////
////        void DrawFont()
////        {
...
////            // FONT ASSET
////            EditorGUI.BeginChangeCheck();
////            EditorGUILayout.PropertyField(m_NonserializedFontProp, k_NonserializedFontLabel);
////            if(!m_NonserializedFontProp.boolValue)
////            {
...
////
////            // MATERIAL PRESET
////            if (m_MaterialPresetNames != null && !isFontAssetDirty && !m_NonserializedFontProp.boolValue)
////            {
////                // UI_PREVIEW_MODIFY_BEGIN
////
////                // EditorGUI.BeginChangeCheck();
...
////
////                rect = EditorGUILayout.GetControlRect(false, 17);
////                EditorGUI.PrefixLabel(rect, new GUIContent(k_MaterialPresetLabel));
////                rect.x += EditorGUIUtility.labelWidth;
////                rect.width -= EditorGUIUtility.labelWidth;
////                if (EditorGUI.Button(rect, new GUIContent(m_MaterialPresetNames[m_MaterialPresetSelectionIndex]))) showScrollView = !showScrollView;
////
////                if (m_FontSharedMaterialProp.objectReferenceValue != null)
////                    m_MaterialPresetIndexLookup.TryGetValue(m_FontSharedMaterialProp.objectReferenceValue.GetInstanceID(), out m_MaterialPresetSelectionIndex);
////
...
////                    {
////                        EditorGUILayout.BeginHorizontal(new GUIStyle { padding = new RectOffset(0, 0, 5, 5)});
////                        GUIStyle boxStyle = GUI.skin.box;
////                        boxStyle.alignment = TextAnchor.MiddleCenter;
////
////                        Texture2D tmpMaterialPreview;
////                        if (m_TMPMaterialPreviewCache.TryGetValue(m_MaterialPresets[i], out tmpMaterialPreview))
////                        {
////                            GUILayout.Box(tmpMaterialPreview, boxStyle, GUILayout.Width(100), GUILayout.Height(100));
////                        }
////                        else
////                        {
////                            tmpMaterialPreview = UIPreviewCommon.CaptureTMPMaterialPreview((TMP_FontAsset)m_FontAssetProp.objectReferenceValue, m_MaterialPresets[i], 100, 100);
////                            GUILayout.Box(tmpMaterialPreview, boxStyle, GUILayout.Width(100), GUILayout.Height(100));
////                            m_TMPMaterialPreviewCache.Add(m_MaterialPresets[i], tmpMaterialPreview);
////                        }
////
////                        EditorGUILayout.BeginVertical(new GUIStyle { padding = new RectOffset((int)EditorGUIUtility.labelWidth - 100, 0, 25, 25)});
////
////                        GUIStyle style = new GUIStyle(EditorStyles.label)
////                        {
////                            alignment = TextAnchor.MiddleCenter
////                        };
////                        EditorGUILayout.LabelField(new GUIContent(m_MaterialPresetNames[i]), style);
////                        if (GUILayout.Button(new GUIContent("选择")))
////                        {
...
////                else
////                {
////                    m_TMPMaterialPreviewCache.Clear();
////                }
////                // UI_PREVIEW_MODIFY_END
////            }
////
